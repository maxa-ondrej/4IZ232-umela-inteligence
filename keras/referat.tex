...
\midrule
default    & 0.543 & 0.733 & 8.52s \\
5-epochs   & 0.682 & 0.507 & 5.75s \\
20-epochs  & 0.494 & 0.767 & 13.99s \\
16-batches & 0.467 & 0.760 & 11.94s \\
64-batches & 0.646 & 0.687 & 6.80s \\
model\_a   & 0.668 & 0.613 & 8.04s \\
model\_c   & 0.433 & 0.773 & 8.85s \\
1d\_cnn    & 0.401 & 0.820 & 10.32s \\
tanh       & 0.502 & 0.753 & 7.99s \\
hinge      & 1.014 & 0.473 & 8.01s \\
sgd        & 0.696 & 0.473 & 5.38s \\
sgd        & 0.696 & 0.473 & 6.93s \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[ht!]
    ...
    \caption{Průběh ztráty pro konfigurace s optimalizátory SGD/RMSprop, které nedosahují dobré konvergence.\label{fig:sgd-loss}}
\end{figure}

\begin{figure}[ht!]
    \centering
    \includegraphics[width=1.0\linewidth]{./images/sgd_accuracy.png}
    \caption{Přesnost pro konfigurace s optimalizátory SGD/RMSprop; výkon zůstává nízký.\label{fig:sgd-acc}}
\end{figure}
